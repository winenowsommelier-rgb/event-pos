...
create table wine_region (
  ...
  quality_tier text,
  classification_id integer references wine_classification(classification_id)
);
...
create index idx_wine_region_classification on wine_region(classification_id);
